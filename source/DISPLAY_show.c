...
T_ULONG NumberMask [10] = {0x3F,0x6, 0x5B ,0x4F,0x66,0x6D, 0x7D, 0x7 ,0xFF, 0x67};
...
void DISPLAY_show_ShowNumber(T_ULONG index , T_ULONG l_transistor){
	T_ULONG *maskIndex; /// POINTER MASKINDEX
